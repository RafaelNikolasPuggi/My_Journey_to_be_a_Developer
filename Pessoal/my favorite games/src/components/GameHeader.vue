<template>
  ...
  >
    <div class="flex flex-wrap items-center gap-5 w-full">
      ...
      <div
        :class="{
          'max-lg:hidden lg:!block': true,
          'max-lg:w-full max-lg:fixed max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-50 max-lg:before:inset-0 max-lg:before:z-50': true,
          block: menuOpen,
        }"
        id="collapseMenu"
      >
        ...
        >
          ...
          <li class="max-lg:border-b max-lg:py-3 px-3">
            <a
              ...
              class="lg:hover:text-[#007bff] text-[#007bff] block font-semibold text-[15px]"
              >Home</a
            >
          </li>
          <li class="max-lg:border-b max-lg:py-3 px-3">
      ...
      <button id="toggleOpen" class="lg:hidden ml-auto" @click="toggleMenu">
        <svg
          class="w-7 h-7"
          fill="#000"
          viewBox="0 0 20 20"
